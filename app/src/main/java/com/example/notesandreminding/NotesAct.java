...
public class NotesAct extends AppCompatActivity {
    ...
    ArrayList<Note> values = new ArrayList<>(WriteNotesActivity.getDateBase().values());
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for (int i = 0; i < values.size(); i++) {
            ...
            listDate.add(values.get(i).calendar);
        }
        hmList.add(hashMap);
        showNotes(hashMap, listDate);
    ...
    AdapterView.OnItemClickListener itemClickListener = new AdapterView.OnItemClickListener() {
        ...
        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
            ...
            String itemCalendar = (String) MapAdapter.listLongD.get(position);
            impText = 1;
            if (item.getKey() != null && item.getValue() != null) {
                ...
                intent.putExtra("dateEditText", itemCalendar);
    ...
    public void showNotes(HashMap<String, String> not, ArrayList<String> listLongDate) {
        MapAdapter adapter = new MapAdapter(not, listLongDate);
